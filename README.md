## schunk_canopen_driver (kinetic) - 1.0.7-0

The packages in the `schunk_canopen_driver` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic schunk_canopen_driver` on `Wed, 11 Oct 2017 09:32:56 -0000`
...
## schunk_canopen_driver (jade) - 1.0.6-0
